...
ENV MATPLOTLIBRC="/usr/local/lib/python2.7/dist-packages/matplotlib/mpl-data/"
ENV LC_ALL=C
...
RUN pip3 install nibabel==2.4.0
RUN pip3 install numpy==1.16.2
RUN pip3 install Pillow==6.2.0
RUN pip3 install pybids==0.9.1
